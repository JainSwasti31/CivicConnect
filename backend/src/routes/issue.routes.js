...
import { createIssue, getIssues, getMyIssues, updateStatus, getLiveLocations } from "../controllers/issue.controller.js";
...
router.get("/live-locations", verifyJWT, authorizeRoles("municipal"), getLiveLocations);
